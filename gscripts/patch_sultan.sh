...
patch_vpnhide() {
	...
	cp "$KERNEL_REPO"/vpnhide/kmod/generated/iface_lists.h "$KERNEL_REPO"/security/vpnhide/generated/
	cp "$KERNEL_REPO"/vpnhide/kmod/generated/hook_ids.h "$KERNEL_REPO"/security/vpnhide/generated/
	apply_patch_optional \
                "$KERNEL_REPO" \
