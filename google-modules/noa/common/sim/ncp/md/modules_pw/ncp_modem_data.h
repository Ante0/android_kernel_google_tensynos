...
#define NOA_MD_FW_TX_BUF_POOL_OFFSET 0x056F1000 // same with kUlbufferPoolRegionOffset
#define NOA_MD_FW_TX_BUF_POOL_BASE DRAM_FAKE_MODEM_MEMORY_BASE + NOA_MD_FW_TX_BUF_POOL_OFFSET
