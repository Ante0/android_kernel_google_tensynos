...
/*
 * Metis LPM chip-dependent settings.
 *
 * Copyright (C) 2024 Google LLC
 */

#ifndef __METIS_LPM_H__
#define __METIS_LPM_H__
...
/*
 *TODO(b/235918452): Correct the offsets. They were copied from Callisto and offsets are
 * different on Europa. Debug dump won't work properly because of wrong offsets.
 */
/* LPM Registers */
...
#define PSM3_CFG_OFFSET 0xe1f8
#define PSM3_START_OFFSET 0xe1fc
#define PSM3_STATUS_OFFSET 0xe200
