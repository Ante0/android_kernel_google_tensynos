...
/*
 * Platform data for the PE26100 battery charger driver.
 */

#ifndef _PE26100_CP_CHARGER_H_
#define _PE26100_CP_CHARGER_H_
...
enum pe26100_cp_error {
	PE26100_CP_ERROR_NONE = 0,
	PE26100_CP_ERROR_RETRY,
	PE26100_CP_ERROR_NOT_ACTIVE,
	PE26100_CP_ERROR_APDO,
	PE26100_CP_ERROR_LOW_VBATT,
};

struct pe26100_cp_platform_data {
	...
	s32		iin_max_offset;
	s32		iin_cc_comp_offset_low;
	s32		iin_cc_comp_offset_high;
	u32		ta_max_vol_2_1;
	u32		ta_max_vol_3_1;
	struct gpio_desc	*mpp_gpio;
	u32		wcrx_vol_up_step;
	u32		wcrx_vol_down_step;
	u32		wcrx_vol_loop_delay;
...
/* AC[0] */
#define PE26100_CP_CHGS_VER		1
#define PE26100_CP_CHGS_VER_MASK	0xff
/* AC[1] APDO */
/* RS[0] */
#define PE26100_CP_CHGS_FLAG_SHIFT	0
#define PE26100_CP_CHGS_FLAG_MASK	0xff
#define PE26100_CP_CHGS_F_STBY	BIT(0)
#define PE26100_CP_CHGS_F_SHDN	BIT(1)
#define PE26100_CP_CHGS_F_DONE	BIT(2)
#define PE26100_CP_CHGS_PRE_SHIFT	8
#define PE26100_CP_CHGS_PRE_MASK	(0xff << PE26100_CP_CHGS_PRE_SHIFT)
#define PE26100_CP_CHGS_RCPC_SHIFT	16
#define PE26100_CP_CHGS_RCPC_MASK	(0xff << PE26100_CP_CHGS_RCPC_SHIFT)
#define PE26100_CP_CHGS_NC_SHIFT	24
#define PE26100_CP_CHGS_NC_MASK	(0xff << PE26100_CP_CHGS_NC_SHIFT)
/* RS[1] */
#define PE26100_CP_CHGS_OVCC_SHIFT	0
#define PE26100_CP_CHGS_OVCC_MASK	(0xffff << PE26100_CP_CHGS_OVCC_SHIFT)
#define PE26100_CP_CHGS_ADJ_SHIFT	16
#define PE26100_CP_CHGS_ADJ_MASK	(0xffff << PE26100_CP_CHGS_ADJ_MASK)
/* RS[2] */
#define PE26100_CP_CHGS_CC_SHIFT	0
#define PE26100_CP_CHGS_CC_MASK	(0xffff << PE26100_CP_CHGS_CC_SHIFT)
#define PE26100_CP_CHGS_CV_SHIFT	16
#define PE26100_CP_CHGS_CV_MASK	(0xffff << PE26100_CP_CHGS_CV_SHIFT)
/* RS[3] */
#define PE26100_CP_CHGS_CA_SHIFT	0
#define PE26100_CP_CHGS_CA_MASK	(0xff << PE26100_CP_CHGS_CA_SHIFT)


struct pe26100_cp_chg_stats {
...
#define pe26100_cp_chg_stats_valid(chg_data) ((chg_data)->valid)

static inline void pe26100_cp_chg_stats_update_flags(struct pe26100_cp_chg_stats *chg_data,
						     u8 flags)
{
	chg_data->receiver_state[0] |= flags << PE26100_CP_CHGS_FLAG_SHIFT;
}

static inline void pe26100_cp_chg_stats_set_flags(struct pe26100_cp_chg_stats *chg_data, u8 flags)
{
	chg_data->receiver_state[0] &= ~PE26100_CP_CHGS_FLAG_MASK;
	pe26100_cp_chg_stats_update_flags(chg_data, flags);
}

static inline void pe26100_cp_chg_stats_inc_ovcf(struct pe26100_cp_chg_stats *chg_data,
...
/**
 * struct pe26100_cp_charger - pe26100 charger instance
 ...
 * @prev_iin: Previous IIN ADC of PE26100, uA
...
struct pe26100_cp_charger {
	...
	struct pe26100_cp_chg_stats	chg_data;
	...
	ktime_t			iin_check_timestamp;
	bool			no_iin_active_check;
	u8			safety_sts[6];
	bool			maintain_fv_cc_max;
	bool			wlc_no_ramp_down;
};
...
enum {
	...
	DC_STATE_ERROR_RECOVER, /* Error recovery */
	DC_STATE_MAX,
};
...
/* PPS timers */
#define PE26100_CP_PDMSG_WAIT_T		250	/* 250ms */
#define PE26100_CP_PDMSG_RETRY_T	1000	/* 1000ms */
#define PE26100_CP_PDMSG_WLC_WAIT_T	2000	/* 2000ms */
#define PE26100_CP_PPS_PERIODIC_T	10000	/* 10000ms */
#define PE26100_CP_TA_CONFIG_WAIT_T	(4 * PE26100_CP_PDMSG_WAIT_T)
#define PE26100_CP_ERROR_WAIT_T		1500	/* 1500ms */

/* - Core driver  ---------------------------- */

s32 pe26100_cp_input_current_limit(struct pe26100_cp_charger *pe26100);
...
s32 pe26100_cp_probe_pps(struct pe26100_cp_charger *pe26100_cp_chg);

s32 pe26100_cp_request_pdo(struct pe26100_cp_charger *pe26100);
s32 pe26100_cp_usbpd_setup(struct pe26100_cp_charger *pe26100);
s32 pe26100_cp_send_pd_message(struct pe26100_cp_charger *pe26100, u32 msg_type);
s32 pe26100_cp_get_apdo_max_power(struct pe26100_cp_charger *pe26100,
			    u32 ta_max_vol, u32 ta_max_cur);
int pe26100_cp_get_apdo_index(struct pe26100_cp_charger *pe26100, unsigned int *ta_max_vol,
			  unsigned int *ta_max_cur, unsigned int *ta_objpos);
s32 pe26100_cp_send_rx_voltage(struct pe26100_cp_charger *pe26100, u32 msg_type);
s32 pe26100_cp_get_rx_max_power(struct pe26100_cp_charger *pe26100);
int pe26100_cp_get_rx_voltage(struct pe26100_cp_charger *pe26100_cp);

s32 pe26100_cp_set_ta_type(struct pe26100_cp_charger *pe26100, s32 pps_index);

/* GBMS integration */
struct power_supply *pe26100_cp_get_rx_psy(struct pe26100_cp_charger *pe26100);
s32 pe26100_cp_get_chg_chgr_state(struct pe26100_cp_charger *pe26100,
			    union gbms_charger_state *chg_state);
s32 pe26100_cp_is_present(struct pe26100_cp_charger *pe26100);
s32 pe26100_cp_get_status(struct pe26100_cp_charger *pe26100);
s32 pe26100_cp_get_charge_type(struct pe26100_cp_charger *pe26100);
int get_chip_info(struct pe26100_cp_charger *chg);
int pe26100_cp_check_active(struct pe26100_cp_charger *pe26100);
...
s32 pe26100_cp_chg_stats_update(struct pe26100_cp_chg_stats *chg_data,
			  const struct pe26100_cp_charger *pe26100);
s32 pe26100_cp_chg_stats_done(struct pe26100_cp_chg_stats *chg_data,
			const struct pe26100_cp_charger *pe26100);
