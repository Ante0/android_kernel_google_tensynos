 ...
 *
 *   hash: 43e3683b2adb9c4f4d2ab41630006ad762b7a382
 *
...
enum AOC_COMMAND {
  ...
  CMD_AUDIO_INPUT_TPU_OFFLOAD_CONFIG_ID = 365, /* [0x016d] ->  struct CMD_AUDIO_INPUT_TPU_OFFLOAD_CONFIG */
  CMD_AUDIO_INPUT_TPU_OFFLOAD_START_ID = 366, /* [0x016e] ->  struct CMD_AUDIO_INPUT_TPU_OFFLOAD_START */
  CMD_AUDIO_INPUT_TPU_OFFLOAD_STOP_ID = 367, /* [0x016f] ->  struct CMD_AUDIO_INPUT_TPU_OFFLOAD_STOP */
  CMD_AUDIO_INPUT_MIC_IAMF_ENABLE_ID = 369, /* [0x0171] ->  struct CMD_AUDIO_INPUT_IAMF_ENABLE */
  CMD_AUDIO_INPUT_MIC_IAMF_DISABLE_ID = 370, /* [0x0172] ->  struct CMD_HDR */
};
 ...
 *   CMD_AUDIO_INPUT_MIC_IAMF_DISABLE_ID, UUID: 3900592f5fd29aee89d7ccfc907734f5
 */
struct CMD_HDR {
...
struct TPU_OFFLOAD_CHUNK_CONFIG {
  int16_t offset;
  uint8_t channels;
  uint8_t bits;
  uint32_t sample_rate;
  uint8_t format;
  uint8_t is_interleave;
} __attribute__((packed));

#define TPU_OFFLOAD_BATCH_COUNT_MAX (4) /* UUID: 94503690491cb84b262d76ad69506731 */

struct TPU_OFFLOAD_BATCH_CONFIG {
  int32_t aoc_ready_fence;
  int32_t tpu_ready_fence;
  int16_t offset;
} __attribute__((packed));
 ...
 * Structure associated with the following commands:
 *
 *   CMD_AUDIO_INPUT_TPU_OFFLOAD_CONFIG_ID, UUID: 31b3dd69456ed889dbc56e69c34013cb
 */
struct CMD_AUDIO_INPUT_TPU_OFFLOAD_CONFIG {
  struct CMD_HDR parent;
  int32_t tpu_offload_id;
  uint32_t address;
  int32_t batch_count;
  struct TPU_OFFLOAD_BATCH_CONFIG batches[TPU_OFFLOAD_BATCH_COUNT_MAX];
  int32_t period_ms;
  struct TPU_OFFLOAD_CHUNK_CONFIG input_chunk_config;
  struct TPU_OFFLOAD_CHUNK_CONFIG output_chunk_config;
  int32_t batch_size;
} __attribute__((packed));
 ...
 * Structure associated with the following commands:
 *
 *   CMD_AUDIO_INPUT_TPU_OFFLOAD_START_ID, UUID: 5c1de966eca2c969f124bd77068c9f79
 */
struct CMD_AUDIO_INPUT_TPU_OFFLOAD_START {
  struct CMD_HDR parent;
  int32_t tpu_offload_id;
  int32_t feature;
} __attribute__((packed));
 ...
 * Structure associated with the following commands:
 *
 *   CMD_AUDIO_INPUT_TPU_OFFLOAD_STOP_ID, UUID: 1dda9bd1c724aeff9765561b60475325
 */
struct CMD_AUDIO_INPUT_TPU_OFFLOAD_STOP {
  struct CMD_HDR parent;
  int32_t tpu_offload_id;
} __attribute__((packed));
 ...
 * Structure associated with the following commands:
 *
 *   CMD_AUDIO_INPUT_MIC_IAMF_ENABLE_ID, UUID: 87ddb4e5def7e55e4e316e9147e2f6ac
 */
...
static inline int AocInterfaceCheck(const void * addr, int size) {
  static const uint8_t uuid_array[AOC_UUID_ENTRIES][AOC_UUID_SIZE] = { 
      ...
      { 0x1d, 0xda, 0x9b, 0xd1, 0xc7, 0x24, 0xae, 0xff, 0x97, 0x65, 0x56, 0x1b, 0x60, 0x47, 0x53, 0x25},
      ...
      { 0x31, 0xb3, 0xdd, 0x69, 0x45, 0x6e, 0xd8, 0x89, 0xdb, 0xc5, 0x6e, 0x69, 0xc3, 0x40, 0x13, 0xcb},
      ...
      { 0x39, 0x00, 0x59, 0x2f, 0x5f, 0xd2, 0x9a, 0xee, 0x89, 0xd7, 0xcc, 0xfc, 0x90, 0x77, 0x34, 0xf5},
      ...
      { 0x5c, 0x1d, 0xe9, 0x66, 0xec, 0xa2, 0xc9, 0x69, 0xf1, 0x24, 0xbd, 0x77, 0x06, 0x8c, 0x9f, 0x79},
      ...
      { 0x87, 0xdd, 0xb4, 0xe5, 0xde, 0xf7, 0xe5, 0x5e, 0x4e, 0x31, 0x6e, 0x91, 0x47, 0xe2, 0xf6, 0xac},
      ...
      { 0x94, 0x50, 0x36, 0x90, 0x49, 0x1c, 0xb8, 0x4b, 0x26, 0x2d, 0x76, 0xad, 0x69, 0x50, 0x67, 0x31},
