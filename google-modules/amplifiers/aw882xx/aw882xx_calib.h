...
#if IS_ENABLED(CONFIG_AW882XX_CALIB)
...
#else
static inline int aw882xx_cali_init(struct aw_cali_desc *cali_desc) { return 0; }
static inline void aw882xx_cali_deinit(struct aw_cali_desc *cali_desc) {}
static inline int aw882xx_cali_svc_get_cali_status(void) { return 0; }
static inline int aw882xx_cali_read_re_from_nvram(int32_t *cali_re, int32_t ch_index) { return 0; }
static inline bool aw882xx_cali_check_result(struct aw_cali_desc *cali_desc) { return true; }
#endif
