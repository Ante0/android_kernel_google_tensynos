...
static void aw_pid_2407_dev_init(struct aw_device *aw_pa)
{
	...
	/*call aw device init func*/
	memcpy(aw_pa->monitor_name, AW_PID_2407_MONITOR_FILE,
		strlen(AW_PID_2407_MONITOR_FILE));
...
static void aw_pid_2329_dev_init(struct aw_device *aw_pa)
{
	...
	/*call aw device init func*/
	memcpy(aw_pa->monitor_name, AW_PID_2329_MONITOR_FILE,
		strlen(AW_PID_2329_MONITOR_FILE));
 ...
 *
 ******************************************************/
static void aw_dev_init_cmm(struct aw_device *aw_pa)
{
	/*call aw device init func*/
