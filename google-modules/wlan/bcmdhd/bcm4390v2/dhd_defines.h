...
/* #define P2P_SKIP_DFS */
	...
	#define DHD_LB_STATS
		...
		#define DHD_TCP_PACING_SHIFT
			...
			#define DHD_LB_CPU_SET8 0x080
			#define DHD_LB_CPU_SET4 0x060
			#define DHD_LB_CPU_SET0 0x01C
		#endif
		...
		#elif IS_ENABLED(CONFIG_BCM4383)
			#define DHD_LB_CPU_SET8 0x040
			#define DHD_LB_CPU_SET4 0x030
			#define DHD_LB_CPU_SET0 0x00C
			#define DHD_LB_CPU_NAPI_RX	/* improve TCP RX performance */
		#endif
	...
	#define CONCAT_DEF_REV_FOR_NOMATCH_VID
		...
		#define AFFINITY_UPDATE_MIN_PERIOD_SEC 6
				...
				#define PKT_COUNT_MID 5000
				#define PKT_COUNT_LOW 3000
				#define DHD_CPUFREQ_MID 5u
				#define DHD_CPUFREQ_BIG 6u
				#define DHD_LITTLE_CORE_PERF_FREQ 1824000u
				#define DHD_MID_CORE_PERF_FREQ 2649000u
				#define DHD_BIG_CORE_PERF_FREQ 3033000u
			#endif
		#elif IS_ENABLED(CONFIG_SOC_LGA)
			#if IS_ENABLED(CONFIG_BCM4390)
				#define PKT_COUNT_HIGH 60000
		...
		#define WAKEUP_KSOFTIRQD_POST_NAPI_SCHEDULE
			...
			#elif IS_ENABLED(CONFIG_BCM4383)
				#define IRQ_AFFINITY_SMALL_CORE 5
