...
static inline void trace___hyp_printk(u8 fmt_id, u64 a, u64 b, u64 c, u64 d)
{
	mod_ops->tracing_mod_hyp_printk(fmt_id, a, b, c, d);
}
#else
static inline void trace_hyp_printk(const char *fmt, ...)
{
}
#endif
