...
#define ARM_SMMU_PMCG_REG_SZ		0x1000
...
#define STRTAB_STE_1_CONT		GENMASK_ULL(16, 13)
...
#define STRTAB_STE_1_TCU_PREFETCH		GENMASK_ULL(57, 56)
#define STRTAB_STE_1_TCU_PREFETCH_FORWARD	2UL
#define STRTAB_STE_1_TCU_PREFETCH_BACKWARD	3UL
...
#define ARM_SMMU_FEAT_PERMS_OVR		(1 << 23)
#define ARM_SMMU_FEAT_PMCG_PAGE0_2000	(1 << 24)
...
#define ARM_SMMU_OPT_RPM_DISABLE	(1 << 6)
#define ARM_SMMU_OPT_NON_COHERENT_TTW	(1 << 7)
#define ARM_SMMU_OPT_SYNC_FW		(1 << 8)
#define ARM_SMMU_OPT_NON_COHERENT_S2_TTW	(1 << 9)
