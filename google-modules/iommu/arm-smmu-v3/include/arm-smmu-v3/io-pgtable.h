...
struct io_pgtable_cfg {
	 ...
	 *
	 * IO_PGTABLE_QUIRK_DISABLE_CONTPTE: Disable use of contiguous bit
	 */
	...
	#define IO_PGTABLE_QUIRK_DISABLE_CONTPTE	BIT(9)
 ...
 * @audit: (optional) Scan pgtables starting from iova, and count number of mappings
 *         and other pgtable related telemetry
 *
...
struct io_pgtable_ops {
	...
	/* audit: Performs an on-demand page table walk to collect telemetry */
	void (*audit)(struct io_pgtable_ops *ops, unsigned long iova,
 ...
 */
int io_pgtable_configure_pixel(struct io_pgtable_cfg *cfg);
