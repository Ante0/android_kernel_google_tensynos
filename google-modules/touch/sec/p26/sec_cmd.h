 ...
 */
#undef pr_fmt
#define pr_fmt(fmt) "gtd: sec_ts: " fmt

#define LOGD(fmt, arg...) pr_debug("%s: "fmt, __func__, ##arg)
#define LOGI(fmt, arg...) pr_info("%s: "fmt, __func__, ##arg)
#define LOGW(fmt, arg...) pr_warn("%s: "fmt, __func__, ##arg)
#define LOGE(fmt, arg...) pr_err("%s: "fmt, __func__, ##arg)
