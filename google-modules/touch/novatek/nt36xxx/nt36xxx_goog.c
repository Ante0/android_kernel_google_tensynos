...
static void nvt_heatmap_decode(const uint8_t *in, const uint32_t in_sz,
...
static int nvt_test_mode_read(struct nvt_ts_data *ts, struct gti_sensor_data_cmd *cmd)
{
	char trace_tag[128];
	int ret = 0;
