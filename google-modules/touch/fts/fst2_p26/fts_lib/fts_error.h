...
#define ERROR_CHECKSUM			((int)0x80000015) /* /< invalid checksum */
/** @}*/
...
#define ERROR_PROD_TEST_PIN  (0x86000000) /* /< production test
							 pin failed */
#define ERROR_PROD_TEST_VSYNC		((int)0x87000000)	/* /< production
							*vsync signal test failed */
...
#define EVT_TYPE_ERROR_MEMORY_OVERFLOW		 0x08/* /< Memory Manager out of
						 * buffer memory */
#define EVT_TYPE_ERROR_FW_CMD_CHECKSUM		 0x41/* /< Firmware command
						 * checksum error */
#define EVT_TYPE_ERROR_FW_CMD_SPI_LEN_EXCEED	 0x42/* /< Firmware command
						 * SPI length exceed error */
...
#define EVT_TYPE_ERROR_VSYNC_STS_DEAD		 0xF3 /* /< Vsync status dead */
/** @}*/
