...
static int syna_set_report_rate(void *private_data, struct gti_report_rate_cmd *cmd)
{
	struct syna_tcm *tcm = private_data;
	u16 config = 0;
	int ret = 0;
...
static int syna_get_report_rate(void *private_data, struct gti_report_rate_cmd *cmd)
{
	struct syna_tcm *tcm = private_data;
	int ret = 0;
	u16 config = 0;
