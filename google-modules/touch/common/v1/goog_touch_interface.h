...
enum gti_calibrate_result ENUM_U32 {
	...
	GTI_CALIBRATE_RESULT_NA = 0xFFFFFFFFu,
};
...
struct gti_optional_configuration {
	...
	int (*get_report_rate)(void *private_data, struct gti_report_rate_cmd *cmd);
