...
/*
 * Google DPA elf helpers defines. Forked from remoteproc_elf_helpers.h
 *
 * Copyright (C) 2024 Google LLC.
 */

#ifndef _GOOGLE_ELF_HELPERS_H
#define _GOOGLE_ELF_HELPERS_H
