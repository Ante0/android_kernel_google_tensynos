...
extern void pixel_init_uic_err_dbg(struct ufs_hba *hba);
...
struct pixel_ops {
	...
	bool (*get_read_boost)(struct ufs_hba *hba);
	int (*set_read_boost)(struct ufs_hba *hba, bool enabled);
#endif
};
