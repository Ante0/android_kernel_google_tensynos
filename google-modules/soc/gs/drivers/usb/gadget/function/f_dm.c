...
static struct usb_function_instance *alloc_inst_dm(bool dm_config)
{
	struct dm_instance *fi_dm;
	int ret;
...
static struct usb_function *function_alloc_dm(struct usb_function_instance *fi, bool dm_config)
{
