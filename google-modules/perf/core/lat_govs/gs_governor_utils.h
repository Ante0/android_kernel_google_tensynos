...
struct cluster_config {
	...
	unsigned int stale_threshold_ms;
...
enum gs_governor_cpu_latgov_state { LATGOV_IDLE, LATGOV_BASE, LATGOV_LATENCY };

struct gs_governor_latgov_state {
	enum gs_governor_cpu_latgov_state state;
