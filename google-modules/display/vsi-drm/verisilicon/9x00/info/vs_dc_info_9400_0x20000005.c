...
static const u64 format_modifier[] = {
	...
	fourcc_mod_vs_custom_code(DRM_FORMAT_MOD_VS_LINEAR),
...
const struct format_limit_info format_limit_list[] = {
	{ SRC, FORMAT_ARGB, 1, 1, 8, 8192, 8, 4320 },
	{ SRC, FORMAT_YUV420, 2, 2, 8, 7680, 8, 4320 },
	{ SRC, FORMAT_YUV422, 2, 1, 8, 7680, 8, 4320 },
	{ SRC, FORMAT_ARGB16161616, 1, 1, 8, 8192, 8, 4320 },
	{ SRC, FORMAT_ARGB_PV, 16, 4, 16, 8192, 8, 4320 },
	{ SRC, FORMAT_YUV420_8BIT_PV, 32, 8, 32, 7680, 8, 4320 },
	{ SRC, FORMAT_YUV420_10BIT_PV, 16, 8, 16, 7680, 8, 4320 },
	{ SRC, FORMAT_ARGB16161616_PV, 32, 2, 32, 8192, 8, 4320 },
	{ ROI, FORMAT_ARGB, 1, 1, 8, 8192, 8, 4320 },
	{ ROI, FORMAT_YUV420, 2, 2, 8, 7680, 8, 4320 },
	{ ROI, FORMAT_YUV422, 2, 1, 8, 7680, 8, 4320 },
	{ ROI, FORMAT_ARGB16161616, 1, 1, 8, 8192, 8, 4320 },
	{ ROI, FORMAT_ARGB_PV, 1, 1, 8, 8192, 8, 4320 },
	{ ROI, FORMAT_YUV420_8BIT_PV, 2, 2, 8, 7680, 8, 4320 },
	{ ROI, FORMAT_YUV420_10BIT_PV, 2, 2, 8, 7680, 8, 4320 },
	{ ROI, FORMAT_ARGB16161616_PV, 1, 1, 8, 8192, 8, 4320 },
	{ SCALER, FORMAT_ARGB, 1, 1, 8, 4096, 8, 4320 },
	{ SCALER, FORMAT_ARGB_PV, 1, 1, 8, 4096, 8, 4320 },
	{ SCALER, FORMAT_YUV420, 1, 1, 8, 4096, 8, 4320 },
	{ SCALER, FORMAT_YUV420_8BIT_PV, 1, 1, 8, 4096, 8, 4320 },
	{ SCALER, FORMAT_YUV420_10BIT_PV, 1, 1, 8, 4096, 8, 4320 },
	{ SCALER, FORMAT_ARGB16161616, 1, 1, 8, 4096, 8, 4320 },
	{ SCALER, FORMAT_ARGB16161616_PV, 1, 1, 8, 4096, 8, 4320 },
};

const struct vs_dc_info dc_info_9400_20000005 = {
	/* DC_REV_0 */
	.name = "DC9400",
	.chip_id = VS_CHIP_ID_9400,
	.revision = 0x7002,
	.pid = 0x02094000,
	.cid = VS_CHIP_CID_20000005,
	...
	.format_limit = format_limit_list,
	.format_limit_size = ARRAY_SIZE(format_limit_list),
	.max_bpc = 24,
	.pitch_alignment = 64,
	.addr_alignment = 256,
	...
	.default_rd_peak_bw_margin_pct = 22,
	/* TODO(b/485714131): This is a workaround, remove when fixed. */
	.default_rd_rt_bw_margin_pct = 15,
	/* TODO(b/516645748): This is a workaround, remove when fixed. */
	.default_rd_rt_bw_min_mbps = 4263,
};
